...
## Documentation
Lates documentation of the Java classes on the [master branch of the KOReaderHistFavParser GitHub repository](https://github.com/mahlzahn/koreaderhistfavparser) can be found at [mahlzahn.github.io/koreaderhistfavparser/docs](https://mahlzahn.github.io/docs/koreaderhistfavparser).
